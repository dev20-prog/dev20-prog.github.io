...
// From cups to other unit conversions
...
// From pounds to other unit conversions
...
// Butter
    else if (ingredient == "Butter" && first == "g" && second == "cups") {
        result = amount/227;
        converted.value = roundNum(result);
    }
...
btn1.addEventListener('click', function() {
    var fluidIngredient = document.getElementById('fluidIngredient').value;
    var convertedFluid = document.getElementById('convertedFluid').value;
    var secondUnitFl = document.getElementById('secondUnitFl');
    var unitFluid = secondUnitFl[secondUnitFl.selectedIndex].value;

    if (convertedFluid == 0 || fluidIngredient.length == 0) {
        alert("Please enter the ingredient and amount.");
    }
    else {
        ...
        li.appendChild(document.createTextNode(fluidIngredient));
        li.appendChild(document.createTextNode(" - "));
        li.appendChild(document.createTextNode(convertedFluid));
        li.appendChild(document.createTextNode(" "));
        li.appendChild(document.createTextNode(unitFluid));
        li.appendChild(document.createTextNode("  "));
...
btn2.addEventListener('click', function() {
    var dryIngredient = document.getElementById('dryIngredient').value;
    var convertedDry = document.getElementById('convertedDry').value;
    var secondUnitDry = document.getElementById('secondUnitDry');
    var unitDry = secondUnitDry[secondUnitDry.selectedIndex].value;

    if (convertedDry == 0 || dryIngredient.length == 0) {
        alert("Please enter the ingredient and amount.");
    }
    else {
        var li = document.createElement("li");
        ...
        delBtn.appendChild(document.createTextNode("Remove"));
        delBtn.setAttribute('class', 'btn btn-danger');
        delBtn.setAttribute('style', 'text-align: right');

        li.appendChild(document.createTextNode(dryIngredient));
        li.appendChild(document.createTextNode(" - "));
        li.appendChild(document.createTextNode(convertedDry));
        li.appendChild(document.createTextNode(" "));
        li.appendChild(document.createTextNode(unitDry));
        li.appendChild(document.createTextNode("  "));
        li.appendChild(delBtn);
...
btn3.addEventListener('click', function() {
    var ingredient = document.getElementById('ingredient');
    var comIngredient = ingredient[ingredient.selectedIndex].value;
    var convertedCom = document.getElementById('convertedCom').value;
    var secondUnitCom = document.getElementById('secondUnitCom');
    var unitCom = secondUnitCom[secondUnitCom.selectedIndex].value;

    if (convertedCom == 0) {
        alert("Please enter the ingredient amount.");
    }
    else {
        var li = document.createElement("li");
        var delBtn = document.createElement("button");
        ...
        li.appendChild(document.createTextNode(comIngredient));
        li.appendChild(document.createTextNode(" - "));
        li.appendChild(document.createTextNode(convertedCom));
        li.appendChild(document.createTextNode(" "));
        li.appendChild(document.createTextNode(unitCom));
        li.appendChild(document.createTextNode("  "));
        li.appendChild(delBtn);
...
function printList() {
    ...
    if (buttons.length == 0) {
        alert("Please add ingredients and their amount.");
    }
    else {
        ...
        var list = document.getElementById('print').innerHTML;

        var a = window.open(',','height=500, width=500');
        a.document.write('<html>');
        a.document.write('<body><br>');
        a.document.write('<h3>Ingredient List</h3>');
